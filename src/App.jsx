...
import Sudoku4x4 from "./Components/Sudoku4x4.jsx";
...
function App() {
    ...
    switch (selectedGame) {
      case "TicTacToe":
        return gameCardWrapper(
          <TicTacToe onBack={() => setSelectedGame(null)} theme={theme} />
        );
      case "SnakeGame":
        return gameCardWrapper(
          <SnakeGame onBack={() => setSelectedGame(null)} theme={theme} />
        );
      case "MemoryGame":
        return gameCardWrapper(
          <MemoryGame onBack={() => setSelectedGame(null)} theme={theme} />
        );
      ...
      case "Sudoku4x4":
        return gameCardWrapper(
          <Sudoku4x4 onBack={() => setSelectedGame(null)} />
        );
      case "GuessNumber":
        return gameCardWrapper(
          <GuessNumber onBack={() => setSelectedGame(null)} />
        );
      case "TypingSpeedTest":
        return gameCardWrapper(
          <TypingSpeedTest onBack={() => setSelectedGame(null)} />
        );
      default:
        return (
          <>
            ...
            >
              <div className="container hero-text-box text-white">
                ...
                <p className="lead fs-4">
                  Dive into the exciting world of digital adventures! Sharpen
                  your skills, challenge your mind, and enjoy endless gaming
                  excitement.
                </p>
              </div>
            </div>
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${
          theme === "light" ? "/lightmode.jpg" : "/darkmode.jpg"
        })`,
